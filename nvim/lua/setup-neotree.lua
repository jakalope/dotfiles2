...
mappings = {
  ...
  --  fd = {
      ...
      kinds = {
          Unknown = { icon = "?", hl = "" },
          Root = { icon = "v", hl = "NeoTreeRootName" },
          File = { icon = "-", hl = "Tag" },
          Module = { icon = "o", hl = "Exception" },
          ...
          Constructor = { icon = "f", hl = "@constructor" },
